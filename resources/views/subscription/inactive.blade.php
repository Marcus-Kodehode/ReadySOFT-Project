        ...
        <div class="w-full max-w-md">
            ...
            <div class="p-8 bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="p-4 mb-6 border-l-4 border-blue-500 rounded bg-blue-50">
                    <p class="mb-2 text-sm font-medium text-blue-800">Need Help?</p>
                ...
                <div class="flex flex-col gap-3">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="w-full px-4 py-2 text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Sign Out
                        </button>
                    </form>
                    
                    <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-center text-gray-700 transition-colors bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        Back to Dashboard
                    </a>
                </div>
            </div>
