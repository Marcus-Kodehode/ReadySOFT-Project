            ...
            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col gap-3" x-data="{ loading: false }">
                    <form method="POST" action="{{ route('logout') }}" @submit="loading = true">
                        ...
                        <button type="submit" 
                                :disabled="loading"
                                class="w-full px-4 py-2 font-medium text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed">
