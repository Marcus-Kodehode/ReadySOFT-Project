        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('resources.store') }}" x-data="{ loading: false }" @submit="if(!$el.querySelector('[x-data]').__x.$data.isFormValid()) { $event.preventDefault(); return; } loading = true">
                        @csrf
