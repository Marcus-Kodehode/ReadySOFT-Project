...
- [x] Ved submit opprettes: User, Tenant, Subscription (active=true) i én transaksjon (PASS PÅ OG JOBB SYKRONISERT MED task.md (TASK 3) LISTEN, TING SKAL FUNGERE SAMMEN OG IKKE DUPLISERES OM DET ER NOE SOM ER GJORT ALLEREDE LEGG TIL KORT AVSNITT I TASK_FR1_SUMMARY.md FILEN OM HVA SOM ER GJORT)



- [x] Bruker redirectes til dashboard etter vellykket registrering (PASS PÅ OG JOBB SYKRONISERT MED task.md (TASK 3) LISTEN, TING SKAL FUNGERE SAMMEN OG IKKE DUPLISERES OM DET ER NOE SOM ER GJORT ALLEREDE LEGG TIL KORT AVSNITT I TASK_FR1_SUMMARY.md FILEN OM HVA SOM ER GJORT)



- [x] Feilhåndtering: Hvis noe feiler, rulles alt tilbake (ingen delvis data) (PASS PÅ OG JOBB SYKRONISERT MED task.md (TASK 3) LISTEN, TING SKAL FUNGERE SAMMEN OG IKKE DUPLISERES OM DET ER NOE SOM ER GJORT ALLEREDE LEGG TIL KORT AVSNITT I TASK_FR1_SUMMARY.md FILEN OM HVA SOM ER GJORT)
