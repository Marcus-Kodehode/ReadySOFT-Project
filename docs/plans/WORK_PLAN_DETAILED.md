...
**Akseptansekriterier:**
- [x] Melding: "Tenant Not Found"
- [x] Forklaring: "The page you're looking for doesn't exist"
- [x] Link: "Go to Home Page"
- [x] Følger design guide i `resources/views/errors/404.blade.php`
- [x] Fil-header og footer i `resources/views/errors/404.blade.php`
...
- [x] Fil-header: `// File: app/Http/Controllers/BookingController.php`
- [x] Fil-footer: `// Booking management controller - tenant administrerer bookinger for sine ressurser` (LAG EN KORT, MEN FORKLARENDE AVSNITT OM HVA VI HAR GJORT I DENNE TASKEN (ALLE SUBTASK UNDER DENNE TASKEN OGSÅ) I FILEN TASK_9_SUMMARY.md FILEN)
...
- [x] Følger design guide i `resources/views/admin/dashboard.blade.php` 
- [x] Fil-header og footer i `resources/views/admin/dashboard.blade.php`LAG EN KORT, MEN FORKLARENDE AVSNITT OM HVA VI HAR GJORT I DENNE TASKEN (ALLE SUBTASK UNDER DENNE TASKEN OGSÅ) I FILEN TASK_10_SUMMARY.md FILEN
