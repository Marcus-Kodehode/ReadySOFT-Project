...
9. [ ] Skriv inn Håkons nummer: 90039911 eller 4790039911 (UTEN +)
10. [ ] Klikk "Send Test SMS (1 Credit)"

### Forventet Resultat
- ✅ Success-melding: "SMS sent successfully (Credits used: 1)"
- ✅ Håkon mottar SMS på 90039911
- ✅ Kun 1 credit brukt fra Teletopia-kontoen
- ✅ Telefonnummer sendt til Teletopia som 4790039911 (uten +)
...
4. Test telefonnummer-format (skal være 4790039911 UTEN +)

## 🎯 Neste Steg
Når test-SMS fungerer:
1. Send test-SMS til Håkon (90039911)
